...
public class SendmailUtil {
    ...
    //发件人邮箱
    private static String myEmailAccount = "519965081@qq.com";

    //发件人邮箱密码（授权码）
    //在开启SMTP服务时会获取到一个授权码，把授权码填在这里
    private static String myEmailPassword = "ftffojioxndkcaja";
    ...
    public static void sendEmail(String toEmailAddress, String emailTitle, String emailContent) throws Exception {
        ...
        msg.setFrom(new InternetAddress(myEmailAccount, "注艺租赁", "UTF-8"));
    ...
    public String sendEmailSystem(String toEmailAddress) {
        try {
            ...
            //邮件主题
//            String emailTitle = "【葬爱家族】发来贺电";
            String emailTitle = "【邮箱验证码】";


            //邮件内容
//            String emailContent = "恭喜您收获英雄联盟皮城警备大区的第80个皮肤【源计划：净化 薇恩】，是时候秀一波了！";
            String emailContent = "您的验证码为：" + verifyCode + "，请于10分钟内完成验证！";
...
//            return CalculatorUtil.getJSONString(0, verifyCode);
    ...
    public static void main(String[] args){
        ...
        sendMail.sendEmailSystem("519965081@qq.com");
    }
